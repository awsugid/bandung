...
src/
  ...
  modules/
    home/            one component per homepage section, plus faqs.ts
    events/          one component per events page section
    comday/          default/ plus one folder per year (26 = 2026), each with index.astro
  pages/
    events.astro
    index.astro
    llms.txt.ts
